 ...
 */
  ...
  include dirname(__FILE__)."/extern/openInviter/autoupdate.php";
  ...
  {
    if ($plugin=='openinviter' OR $plugin=='openinviter_base') return dirname(__FILE__)."/extern/openInviter/{$plugin}.php";
    else return dirname(__FILE__)."/extern/openInviter/plugins/{$plugin}.php";
  }
